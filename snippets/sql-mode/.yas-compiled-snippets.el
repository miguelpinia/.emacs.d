...
(yas-define-snippets 'sql-mode
                     '(("sel1" "select ${1:*} from $2;" "select" nil
                        nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/select"
                        "direct-keybinding" nil)
                       ("schema" "create schema ${1:schema};\n$0"
                        "schema" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/schema"
                        "direct-keybinding" nil)
                       ("references"
                        "REFERENCES ${1:TableName}([${2:ColumnName}])\n"
                        "REFERENCES ..." nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/references"
                        nil nil)
                       ("nuevo"
                        "  -- ${2:descripción}\n  , ${1:dato}\n$0"
                        "inserta nuevo elemento" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/nuevo"
                        "C-c C-m C-k" nil)
                       ("insert"
                        "insert into ${1:tabla} (${2:columnas}) values (${3:valores});\n$0"
                        "insert" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/insert"
                        "direct-keybinding" nil)
                       ("drtab" "drop table if exists ${1:table};\n$0"
                        "drtab" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/drtab"
                        "direct-keybinding" nil)
                       ("drschc"
                        "drop schema ${1:schema} cascade;\n$0"
                        "drschc" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/drschc"
                        "direct-keybinding" nil)
                       ("drpv" "drop view if exists ${1:view};\n$0"
                        "drpv" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/drpv"
                        "direct-keybinding" nil)
                       ("do"
                        "do language plpgsql $$\ndeclare\n${1:atributos}\nbegin\n${0:instrucciones}\nend;\n$$"
                        "do" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/do"
                        "direct-keybinding" nil)
                       ("create.1"
                        "CREATE PROCEDURE [${1:dbo}].[${2:Name}] \n(\n		$3		$4		= ${5:NULL}		${6:OUTPUT}\n)\nAS\nBEGIN\n$0\nEND\nGO\n"
                        "create procedure ..." nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/create.1"
                        nil nil)
                       ("create"
                        "create table ${1:tabla} (\n  -- ${2:Descripción}\n  id serial primary key\n  $0\n);"
                        "create" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/create"
                        "direct-keybinding" nil)
                       ("constraint.1"
                        "CONSTRAINT [${1:FK_Name}] FOREIGN KEY ${2:CLUSTERED} ([${3:ColumnName}]) \n"
                        "CONSTRAINT [..] FOREIGN KEY ..." nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/constraint.1"
                        nil nil)
                       ("constraint"
                        "CONSTRAINT [${1:PK_Name}] PRIMARY KEY ${2:CLUSTERED} ([${3:ColumnName}]) \n"
                        "CONSTRAINT [..] PRIMARY KEY ..." nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/constraint"
                        nil nil)
                       ("column"
                        "	,	${1:Name}		${2:Type}			${3:NOT NULL}\n"
                        ", ColumnName ColumnType NOT NULL..." nil nil
                        nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/column"
                        nil nil)
                       ("begin"
                        ...
                        "begin" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/begin"
                        "direct-keybinding" nil)
                       ("be"
                        "begin;\nset client_encoding = 'utf-8';\n\n$0\n\ncommit;"
                        "begin sql" nil nil nil
                        "/Users/mangelpa/.emacs.d/snippets/sql-mode/be"
                        "direct-keybinding" nil)))
